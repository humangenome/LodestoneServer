...
HOSTING_URL="https://www.survivalservers.com/services/game_servers/delverium/?utm_source=github&utm_medium=release_notes&utm_campaign=lodestone"
...
rendered=$(printf '%s\n\n---\n\nHosting: [SurvivalServers.com](%s) runs Lodestone for you.\n' "${body}" "${HOSTING_URL}")
